...
// Tutor pages
import TutorLibrary from './pages/tutor/Library';
...
function AppShell() {
  ...
  const pageTitle: Record<string, string> = {
    ...
    '/app/packs': '📦 Content Packs',
    '/app/library': user?.role === 'ADMIN' ? '📄 PDF Library' : '📦 Shared Library',
          ...
          <Routes>
            {isStaff ? (
              <>
                ...
                {isAdmin && <Route path="packs" element={<AdminPacks />} />}
                <Route path="library" element={isAdmin ? <AdminPdfLibrary /> : <TutorLibrary />} />
